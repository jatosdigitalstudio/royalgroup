...
export default function Quote() {
    return (
      <section className='flex justify-center items-center px-6 bg-blue overflow-hidden'>
        <div className='flex flex-col relative items-center py-32 '>
          ...
          <Image 
              ...
              className='absolute top-0 z-10 brightness-100'
          />
        </div>  
      </section>
    )
